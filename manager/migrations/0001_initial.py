# -*- coding: utf-8 -*-
# Generated by Django 1.9.9 on 2016-08-27 08:12
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField()),
                ('hosts', models.ManyToManyField(blank=True, related_name='groups', to='manager.Host', verbose_name='Hosts')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='host',
            name='idc',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='manager.IDC'),
        ),
    ]
